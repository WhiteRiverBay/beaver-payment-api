...
public class RedisUtils implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        this.set("__test__", "ok");
        log.info("RedisUtils init success");
    }
     ...
     * @return
     */
    public boolean push(String queue, Object value) {
        try {
    ...
    public Object zscore(String key, String member) {
